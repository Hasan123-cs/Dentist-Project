        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextReminderDate = table.Column<DateOnly>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ToothTreatments_MedicalRecords_MedicalRecordId",
                        column: x => x.MedicalRecordId,
                        principalTable: "MedicalRecords",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ToothTreatments_Teeth_ToothId",
                        column: x => x.ToothId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teeth_Number",
                table: "Teeth",
                column: "Number",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ToothTreatments_MedicalRecordId",
                table: "ToothTreatments",
                column: "MedicalRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_ToothTreatments_ToothId",
                table: "ToothTreatments",
                column: "ToothId");
